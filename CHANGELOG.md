...
### Compatibility
- The Sendspin client and server move in lockstep on the encryption/pairing spec, so the SDK version must match the `aiosendspin` version your server bundles. This supersedes the note under 0.21.2:
